<template>
    <vcade title="账户权限">
        <div slot="content">
            ...
            <div class="fl right">
                <p style="width:100%;color:#333333; margin-bottom:20px;">在你创建员工账户后，当员工登录相应账号时，能使用您授权给他们的权限功能</p>
                <p class="font" style="line-height:30px; width:100%;">
                   如果你选择为员工开通该权限，则表示你确认知晓正丽科技相关治疗系统是需要开具委托加工单的，并且你给予权限的员工具备相关有效资格，可以为相关治疗开具委托加工单，同时也能审阅修改3D设计方案等。
                </p>
            </div>
